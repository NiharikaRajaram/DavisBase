...
public enum DataType {
    ...
    private static final Map<Byte, DataType> dataTypeLookup = new HashMap<>();
    private static final Map<Byte, Integer> dataTypeSizeLookup = new HashMap<>();
    private static final Map<String, DataType> dataTypeStringLookup = new HashMap<>();
    private static final Map<DataType, Integer> dataTypePrintOffset = new HashMap<>();
