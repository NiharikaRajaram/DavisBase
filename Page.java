...
public class Page {
    ...
    public void addNewColumn(ColumnInfo columnInfo) {
        try {
            addTableRow(DavisBaseBinaryFile.columnsTable, Arrays.asList(new Attribute(DataType.TEXT, columnInfo.tableName),
    ...
    private void handleIndexOverflow() throws IOException {
        if (pageType == PageType.LEAFINDEX) {
            ...
            int comparisonResult = Command.Condition.compare(incomingInsertTemp.indexValue.fieldValue, toInsertParentIndexNode.indexValue.fieldValue, incomingInsert.indexValue.dataType);
    ...
    private void cleanPage() throws IOException {
        ...
        availableSpace = contentStartOffset - 0x10; // this page will now be treated as a new page
